module.exports = {
  ...
  sdlj: {
    ...
    HOSPITAL_NAME_SPACE: '"广东医科大学附属第三医院佛山市顺德区龙江医院"',
    COMPANY_NAME: '"宸瑞普惠(广州)科技有限公司"',
    ABOUT_INFO: '"关于宸瑞普惠"',
    title: '"智慧护理信息系统"'
  },
  ...
  whsl: {
    ...
    HOSPITAL_NAME_SPACE: '"威 海 市 立 医 院"',
    COMPANY_NAME: '"百辰源(广州)科技有限公司"',
    ABOUT_INFO: '"关于百辰源"',
    title: '"威海市立护理信息系统"',
    hasFollow:true
  ...
  whhk: {
    HOSPITAL_ID: '"whhk"',
    HOSPITAL_NAME: '"武汉市汉口医院"',
    HOSPITAL_NAME_SPACE: '"武 汉 市 汉 口 医 院"',
    COMPANY_NAME: '"宸瑞普惠(广州)科技有限公司"',
    ABOUT_INFO: '"关于宸瑞普惠"',
    title: '"智慧护理信息系统"',
    ENABLE_BLUETOOTH_SIGN: true
  ...
  '925': {
    HOSPITAL_ID: '"925"',
    HOSPITAL_NAME: '"中国人民解放军联勤保障部队第九二五医院"',
    HOSPITAL_NAME_SPACE: '"中 国 人 民 解 放 军 联 勤 保 障 部 队 第 九 二 五 医 院"',
    COMPANY_NAME: '"宸瑞普惠(广州)科技有限公司"',
    ABOUT_INFO: '"关于宸瑞普惠"',
    title: '"智慧护理信息系统"',
    ENABLE_BLUETOOTH_SIGN: false,
  ...
  'dglb': {
    HOSPITAL_ID: '"dglb"',
    HOSPITAL_NAME: '"东莞市寮步医院"',
    HOSPITAL_NAME_SPACE: '"东 莞 市 寮 步 医 院"',
    COMPANY_NAME: '"宸瑞普惠(广州)科技有限公司"',
    ABOUT_INFO: '"关于宸瑞普惠"',
    title: '"智慧护理信息系统"',
    ENABLE_BLUETOOTH_SIGN: false
  ...
  "sdhpwk": {
    HOSPITAL_ID: '"sdhpwk"',
    HOSPITAL_NAME: '"顺德和平外科医院"',
    HOSPITAL_NAME_SPACE: '"顺 德 和 平 外 科 医 院"',
    COMPANY_NAME: '"宸瑞普惠(广州)科技有限公司"',
    ABOUT_INFO: '"关于宸瑞普惠"',
    title: '"智慧护理信息系统"',
    ENABLE_BLUETOOTH_SIGN: false
  ...
  "dgdl": {
    HOSPITAL_ID: '"dgdl"',
    HOSPITAL_NAME: '"东莞市大朗医院"',
    HOSPITAL_NAME_SPACE: '"东 莞 市 大 朗 医 院"',
    COMPANY_NAME: '"百辰源(广州)科技有限公司"',
    ABOUT_INFO: '"关于宸瑞普惠"',
    title: '"智慧护理信息系统"',
    ENABLE_BLUETOOTH_SIGN: false
