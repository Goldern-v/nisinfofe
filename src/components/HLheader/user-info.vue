<template>
  <div class="info-con">
    ...
    <div v-if="['liaocheng','foshanrenyi','fsxt','lyxrm','beihairenyi', 'whhk', '925' ,'gdtj', 'stmz','nfyksdyy','qhwy','whsl','zjhj','hzly'].includes(HOSPITAL_ID)">
...
export default {
  ...
  data() {
    return {
      ...
      ca_isLogin: "",
      strUserCertID: "",
      showScaleTip:['huadu', 'nfyksdyy','sdhpwk'].includes(this.HOSPITAL_ID),
      userName: "",
      passWord: "",
      fuyouCaData:null,//江门妇幼ca签名认证数据
      isUpdateFuyouCaData:true,
      // hasQrCaSignHos:['fuyou','hj'],
      hasQrCaSignHos:['fuyou','hj','guizhou1','zhzxy'],
      userNum:0,
