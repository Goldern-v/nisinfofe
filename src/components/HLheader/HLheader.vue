    ...
    <div id="hl-nav-con">
      <div class="header-con">
        <el-row type="flex"
          ...
          <el-row class="left-part"
                  type="flex">
            <el-row class="logo-con"
                    type="flex"
                    justify="center"
                    align="middle">
            ...
            <router-link to="/deliveryRoomWhiteboard"
                         tag="span"
            ...
            <router-link to="/familyBigScreen"
                         tag="span"
                         v-if="deptCode == '051102_01'">
              <el-row class="nav-item"
                      type="flex"
            ...
            <el-dropdown menu-align="start"
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item :class="{active: $route.path == '/sheetHospitalAdmission'}">
                  <router-link to="/sheetHospitalAdmission"
                               tag="span">
                ...
                <el-dropdown-item :class="{active: $route.path == '/sheetHospitalEval'}">
                  <router-link to="/sheetHospitalEval"
                               tag="span">
                    <el-row class="menu-item"
                            type="flex"
                            align="middle">
            ...
            <router-link to="/implementationList"
                         tag="span">
              <el-row class="nav-item"
                      type="flex"
                      align="middle">
            ...
            <router-link to="/badEvent"
                         tag="span">
              <el-row class="nav-item"
                      type="flex"
                      align="middle">不良事件</el-row>
            </router-link>
            ...
            <el-dropdown menu-align="start"
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item :class="{active: $route.path == '/nursingDocumentation'}">
                  <router-link to="/nursingDocumentation"
                               tag="span">
                    <el-row class="menu-item"
                            type="flex"
                            align="middle">
                ...
                <el-dropdown-item :class="{active: $route.path.indexOf('/inpatientReport') > -1}">
                  <router-link to="/inpatientReport"
                               tag="span">
                    <el-row class="menu-item"
                            type="flex"
                            align="middle">
                ...
                <el-dropdown-item :class="{active: $route.path == '/departmentSharedFile'}">
                  <router-link to="/departmentSharedFile"
                               tag="span">
                    <el-row class="menu-item"
                            type="flex"
                            align="middle">
                ...
                <el-dropdown-item v-if="deptCode.match('051102')"
                                  :class="{active: $route.path == '/puerperantSituation'}">
                  <router-link to="/puerperantSituation"
                               tag="span">
                    <el-row class="menu-item"
                            type="flex"
                            align="middle">
                ...
                <el-dropdown-item :class="{active: $route.path == '/vaccineManagement'}"
                                  v-if="deptName.includes('产科')">
                  <router-link to="/vaccineManagement"
                               tag="span">
                    <el-row class="menu-item"
                            type="flex"
                            align="middle">
                ...
                <el-dropdown-item :class="{active: $route.path == '/birthCertificate'}"
                                  v-if="deptCode.match('051102')">
                  <router-link to="/birthCertificate"
                               tag="span">
                    <el-row class="menu-item"
                            type="flex"
                            align="middle">
                ...
                <el-dropdown-item>
                  <router-link to="/healthEducationList"
                               tag="span">
                    <el-row class="menu-item"
                            type="flex"
                            align="middle">
          ...
          <el-row class="right-part"
            ...
            <span class="big-1250-con">
              <el-popover ref="popover1"
                          ...
                          width="320"
                          trigger="click">
                <userInfo @setPassword="setPassword"
                          @quit="quit"></userInfo>
              </el-popover>
              <span>
                <el-select v-model="deptValue"
                           filterable
                           remote
                           placeholder="请选择"
                           size="small"
                  ...
                  <el-option v-for="item in deptOptionList"
                             :key="item.code"
                             :label="item.name"
              ...
              <span class="option-item"
                    v-popover:popover1>{{user.empName}}</span>
            </span>
