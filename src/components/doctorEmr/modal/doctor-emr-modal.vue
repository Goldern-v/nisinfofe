<template>
  <sweet-modal ref="modalName" title="病历" class="modal-con" :colseShadow="['zhzxy','fsxt','dglb'].includes(HOSPITAL_ID)"  :modalWidth="['zhzxy','fsxt','dglb'].includes(HOSPITAL_ID) ? 1200 : 0" >
    <doctorEmr></doctorEmr>
    <!-- <div slot="button">
