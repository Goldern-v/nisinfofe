...
axios.interceptors.request.use((config) => {
    ...
    if (config.url.indexOf('login') > -1 || config.url.indexOf('autoLogin') > -1 || config.url.indexOf('logout') > -1 || config.url.indexOf('resetPassword') > -1 || config.url.indexOf('formTemplateShow') > -1) return config
