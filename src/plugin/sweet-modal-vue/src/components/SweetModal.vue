...
export default {
  ...
  methods: {
    ...
    open(tabId = null,ifNoguan =true) {
      ...
      this.$refs.dragBox.style.top = ['zhzxy','fsxt'].includes(this.HOSPITAL_ID) && this.colseShadow ? '100%' : "50%";
    ...
    _onOverlayClick(event) {
      if (
        ...
        if (this.blocking) {
          ...
          // 医院名单
          const blackList=['guizhou','foshanrenyi','wujing','fsxt', 'whfk' , 'gdtj', 'zhzxy','fsxt','nfyksdyy','whsl', 'dglb']
