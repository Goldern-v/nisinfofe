<template>
  <div class="d-table">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span
            :class="'btn-text'"
            @click="openViewModal2(scope.row)"
          >添加</span>
          <span
    ...
    <nursingRoundsModal2 ref="nursingRoundsModal2" :getData="getData"></nursingRoundsModal2>
  </div>
</template>
...
import nursingRoundsModal2 from "../modal/nursingRoundsModal2";
...
export default {
  ...
  methods: {
    ...
    openViewModal2(data,flag=false) {
      this.$refs.nursingRoundsModal2.open(data,flag);
    },
    deleteData(data) {
      this.form = {
        empNo:this.empNo, // --工号
