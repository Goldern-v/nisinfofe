        ...
        <div ref="printable" data-print-style="height: auto;">
          <div class="head shift-paper">
            ...
            <div class="details">
              ...
              <span>
                死亡：<b>{{ record.patientDead || 0 }}</b>人，
              </span>
              <span>
                新入：<b>{{ record.inHospitalTotal || 0 }}</b>人，
              </span>
              <span>
                转入：<b>{{ record.transInTotal || 0 }}</b>人，
              </span>
              <span>
                手术：<b>{{ record.operationTotal || 0 }}</b>人，
              </span>
              <span>
            ...
            <div class="details" style="margin-top: 5px;">
              ...
              <span>
                跌倒高危：<b>{{ record.patientFall || 0 }}</b>人，
              </span>
              <span>
                VTE高危：<b>{{ record.patientVte || 0 }} </b>人
              </span>
              <span>
                交班日期：
