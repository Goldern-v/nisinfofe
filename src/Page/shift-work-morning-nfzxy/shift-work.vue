    ...
    <div class="left-side">
      ...
      <div class="list" v-loading="loading">
        <router-link
          ...
          :to="{name: 'morningShiftWork', params: {code: record.deptCode, id: record.id}}"
          :key="record.id"
        >
  ...
  export default {
    ...
    watch: {
      deptCode (value, oldValue) {
        this.$router.push({path: '/morningShiftWork'})
      },
      '$route.params.code' () {
        this.load()
      }
    ...
    methods: {
      ...
      async onCreateModalConfirm ({date, code, copy, done}) {
        ...
        this.$router.push({name: 'morningShiftWork', params: {code, id: res.data.data.id}})
