     ...
     <div class="info">
      ...
      <div class="bottomCon">
        ...
        <div class="showModal">
          分娩方式：
           <input
            v-if=" sheetInfo.sheetType==='oxytocin_dglb'||sheetInfo.sheetType==='oxytocin_sdry' || sheetInfo.sheetType==='oxytocin_hzly'"
            type="text"
            class="bottomInput bottom-line"
...
export default {
  ...
  mounted() {
    ...
    if((this.sheetInfo.sheetType==='oxytocin_sdry' || this.sheetInfo.sheetType==='oxytocin_hzly' )  &&this.index!=0){
      // 催产素使用总量
