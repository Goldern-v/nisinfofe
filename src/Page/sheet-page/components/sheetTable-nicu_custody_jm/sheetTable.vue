              ...
              <td style="width:195px">
                ...
                <div class="boxLine">
                  <input
                    type="checkbox"
                    value="腹腔引流管"
                    :ischecked="sheetInfo.relObj.fqylg"
                    v-model="checkedbsxqylg"
                  />腹腔引流管
                </div>
                <div class="boxLine">
                ...
                <div class="boxLine">
                  ...
                  <div class="boxRight">
                    <input
                      ...
                      style="width:30px;"
                      class="bottomInput"
                      v-model="sheetInfo.relObj.bwzc"
                      :data-value="sheetInfo.relObj.bwzc"
                    />cm
                  </div>
                  ...
                  <div class="boxRight">
                    <input
                      ...
                      style="width:30px;"
                      class="bottomInput"
                      v-model="sheetInfo.relObj.bwyc"
                      :data-value="sheetInfo.relObj.bwyc"
                    />cm
                  </div>
                </div>
                <div class="boxLine">
              ...
              <td style="width:150px">
                <div class="boxLine">
                  ...
                  <div class="boxRight">
                    <input
                      ...
                      style="width:96%;"
                      class="bottomInput"
                      v-model="sheetInfo.relObj.fzcaqcs"
                      :data-value="sheetInfo.relObj.fzcaqcs"
                    />
                  </div>
                </div>
                <div class="boxLine">
                  <input
                    type="checkbox"
                    value="放置防坠床警示标识"
                    :ischecked="sheetInfo.relObj.fzjsbs"
                ...
                <div class="boxLine">
                  <input
                    type="checkbox"
                    value="拉好抢救台挡栏"
                    :ischecked="sheetInfo.relObj.lhdl"
                    v-model="checkedlhdl"
                  />拉好抢救台挡栏
                </div> 
                <div class="boxLine">
                  <input
                    type="checkbox"
                    value="关好箱门"
                    :ischecked="sheetInfo.relObj.ghxm"
                    v-model="checkedghxm"
                  />关好箱门
                </div>
              </td>
