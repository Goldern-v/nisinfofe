...
import {
  ...
  export default [
    ...
    { key: 'armValue', event: keyf1, value: '', textarea: { width: 65 }, change: (e, td) => limitChange(e, td, 10) },
    { key: 'breath', event: keyf1, value: '', next: '次/分', name: '呼吸', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
    { key: 'bloodPressure', event: keyf1, value: '', next: 'mmHg', name: '血压', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 6) },
    { key: 'spo2', event: keyf1, value: '', next: '%', name: 'SPO2', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
    { key: 'consciousness', event: keyf1, value: '',name: '意识', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 6) ,autoComplete: { data: ["清醒√","嗜睡+","昏睡","浅昏迷++","深昏迷+++","模糊","谵妄","植物状态","睁眼昏迷"] }},
    // 出入量
    { key: 'food', event: keyf1, value: '', next: '', name: '入量', textarea: { width: 60 }, change: (e, td) => limitChange(e, td, 8)},
    { key: 'foodSize', event: keyf1, value: '', next: 'ml', name: '入量量', textarea: { width: 40 }, change: (e, td) => limitChange(e, td, 6) },
    { key: 'discharge', event: keyf1, value: '', next: '', name: '出量', textarea: { width: 60 }, change: (e, td) => limitChange(e, td, 8) },
    ...
    { key: 'armValue3', event: keyf1, value: '', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
