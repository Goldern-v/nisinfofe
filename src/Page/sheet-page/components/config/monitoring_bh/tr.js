...
import {
  ...
  export default [
    ...
    { key: 'heartRate', event: keyf1, value: '', next: '次/分', name: '心率',textarea: { width: 100 }, change: (e, td) => limitChange(e, td, 14) },
    { key: 'bloodPressure', event: keyf1, value: '', next: 'mmHg', name: '血压',textarea: { width: 100 }, change: (e, td) => limitChange(e, td, 14) },
    { key: 'pulse', event: keyf1, value: '', next: '次/分', name: '脉搏',textarea: { width: 100 }, change: (e, td) => limitChange(e, td, 14) },
