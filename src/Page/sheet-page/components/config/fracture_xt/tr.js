...
export default [
  ...
  { key: 'swelling', event: keyf1, value: '', next: '', name: '肿胀', autoComplete: { data: 患肢肿胀 }, textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'peelwin', event: keyf1, value: '', next: '', name: '皮温', autoComplete: { data: 患肢皮温 }, textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'color', event: keyf1, value: '', next: '', name: '颜色', autoComplete: { data: 患肢颜色 }, textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'feel', event: keyf1, value: '', next: '', name: '感觉', autoComplete: { data: 患肢感觉 }, textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'raiseLimb', event: keyf1, value: '', next: '', name: '抬高患肢15cm', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
