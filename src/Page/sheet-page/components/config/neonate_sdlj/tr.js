...
export default [
  ...
  { key: 'complexion', event: keyf1, value: '', next: '', name: '肤色', autoComplete: { data: [{name: '①红润',value: '①'},{name: '②黄染',value: '②'},{name: '③苍白',value: '③'},{name: '④苍灰',value: '④'},{name: '⑤干燥',value: '⑤'},{name: '⑥紫绀',value: '⑥'},{name: '①红润',value: '①'},]}, textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'glhlCare', event: keyf1, value: '', next: '', name: '光疗护理', autoComplete: { data: [{name: '①戴眼罩，保护外阴，戴手套脚套1111111111',value: '①'},] }, textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
