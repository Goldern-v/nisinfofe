...
export default [
  ...
  { key: 'complexion', event: keyf1, value: '', next: '', name: '肤色', autoComplete: { data: ['①','②','③','④','⑤','⑥']}, textarea: { width: 25 }, splice: '/', change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'situation', event: keyf1, value: '', next: '', name: '脐部情况', autoComplete: { data: ['①','②','③','④'] }, textarea: { width: 25 }, splice: '/', change: (e, td) => limitChange(e, td, 2) },
  { key: 'periderm', event: keyf1, value: '', next: '', name: '肛周皮肤', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'phototherapy', event: keyf1, value: '', next: '', name: '光疗情况', autoComplete: { data: ['①','②','③','④','⑤'] }, textarea: { width: 25 }, splice: '/', change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'cleanCare', event: keyf1, value: '', next: '', name: '清洁护理', splice: '/', autoComplete: { data: ['①','②','③','④','⑤'] }, textarea: { width: 55 }, change: (e, td) => limitChange(e, td, 8) },
  { key: 'glhlCare', event: keyf1, value: '', next: '', name: '光疗护理', splice: '/', autoComplete: { data: ['①','②','③'] }, textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
  { key: 'airwayCare', event: keyf1, value: '', next: '', name: '气道护理', splice: '/', autoComplete: { data: ['①','②','③'] }, textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
  { key: 'nurse', event: keyf1, value: '', next: '', name: '专科护理', splice: '/', autoComplete: { data: ['①','②','③'] }, textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
