...
export default [
  ...
  { key: 'nausea', event: keyf1, value: '', next: '', name: '恶心/呕吐', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
  { key: 'armValue3', event: keyf1, value: '', next: '', name: '腰部疼痛（数字分析法）', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
  { key: 'irritation', event: keyf1, value: '', next: '', name: '尿频/尿急/尿痛', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
  { key: 'dysuria', event: keyf1, value: '', next: '', name: '排尿/困难/血尿', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
  { key: 'urineTube', event: keyf1, value: '', next: '', name: '留置/尿管/尿色', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
