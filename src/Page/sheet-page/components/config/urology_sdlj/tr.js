...
export default [
  ...
  { key: 'nausea', event: keyf1, value: '', next: '', name: '恶心', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'vomiting', event: keyf1, value: '', next: '', name: '呕吐', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'abdominal', event: keyf1, value: '', next: '', name: '腰腹部疼痛', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
  { key: 'irritation', event: keyf1, value: '', next: '', name: '尿路刺激征', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
  { key: 'dysuria', event: keyf1, value: '', next: '', name: '排尿困难', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
  { key: 'bloodUrine', event: keyf1, value: '', next: '', name: '血尿', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'urineTube', event: keyf1, value: '', next: '', name: '留置尿管', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'urineColor', event: keyf1, value: '', next: '', name: '尿色', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
