...
import {
  ...
  export default [
    ...
    { key: 'pulse2', event: keyf1, value: '', next: '次/分', name: '脉搏',textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
    ...
    { key: 'outputAmount', event: keyf1, value: '', next: 'ml', name: '入量量', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
    { key: 'outputName', event: keyf1, value: '', next: '', name: '出量', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8),autoComplete: { data: ['尿量','大便','胃液','呕吐液','痰液','胆汁','胰液','肠液','胃造瘘','左引流液','腹腔引流','左胸液','右胸液','上胸液','下胸液','盆腔引流','痰液','头部引流液'] } },
    { key: 'outputQuantity', event: keyf1, value: '', next: 'ml', name: '出量量', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
    { key: 'outputColor', event: keyf1, value: '', next: '', name: '出量颜色', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4),autoComplete: { data: ['黄白色','血丝色','血色','血性','淡青色','棕色','奶油色','灰色','绿色','粉红色','淡粉色','黄褐色','白色','黄色','其他'] } },
    ...
    { key: 'pipeline', event: keyf1, value: '', name: '管道情况', textarea: { width: 140 }, change: (e, td) => limitChange(e, td, 25),autoComplete: { data: ['无','导尿管','胃管','浅静脉留置针','气切','气管插管','气切套管','PICC','输液港','CVC','胸腔引流管','脑室引流管','硬膜下引流管','硬膜外引流管'] },splice:true},
