...
export default [
  ...
  { key: 'reaction', event: keyf1, value: '', next: '', name: '反应', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4), autoComplete:{data:["好","一般","稍差","差"]} },
  ...
  { key: 'skinColor', event: keyf1, value: '', next: '', name: '皮肤颜色', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 6),autoComplete:{data:["红润","发灰","苍白","花斑" , '轻黄' , '中黄' , '重黄']} },
  { key: 'state', event: keyf1, value: '', next: '', name: '意识状态', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 6) ,autoComplete:{data:["清醒","睡眠","烦躁", '激惹', '嗜睡', '昏迷']}},
