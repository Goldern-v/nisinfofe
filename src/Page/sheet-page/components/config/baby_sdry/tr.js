...
export default [
  ...
  { key: 'vomitColor', event: keyf1, value: '', next: '', name: '呕吐颜色性质',
   textarea: { width: 45 }, 
   autoComplete: { data: ["血性液", "淡红色液体","暗红色液","黄色液","咖啡色液","白色粘液"] },
   change: (e, td) => limitChange(e, td, 6)},
  { key: 'umbilicus', event: keyf1, value: '', next: '', name: '脐带情况',ischange: true,
  textarea: { width: 50 },
  autoComplete: { data: ["干洁", "渗血","渗液"] },
  change: (e, td) => limitChange(e, td, 8)
