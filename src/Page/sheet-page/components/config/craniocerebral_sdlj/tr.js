...
export default [
  ...
  { key: 'consciousness', event: keyf1, value: '', next: '', name: '意识', autoComplete: { data: ['清√','嗜睡+','浅昏迷++','深昏迷+++','药眠'],dataVal:['√','+','++','+++','药眠'] }, textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  ...
  { key: 'nausea', event: keyf1, value: '', next: '', name: '恶心', textarea: { width: 30 },autoComplete: { data: ['无','√','间有'] }, change: (e, td) => limitChange(e, td, 2) },
