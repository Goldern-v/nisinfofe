...
export default [
  ...
  { key: 'consciousness', event: keyf1, value: '', next: '', name: '意识', autoComplete: { data: ['清√','嗜睡+','浅昏迷++','深昏迷+++','药眠'] }, textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  ...
  { key: 'reflectionLeft', event: keyf1, value: '', next: '', name: '瞳孔反射左', autoComplete: { data: ['灵敏√','迟钝+','消失－'] }, textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'reflectionRight', event: keyf1, value: '', next: '', name: '瞳孔反射右', autoComplete: { data: ['灵敏√','迟钝+','消失－'] }, textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'outputContent', event: keyf1, value: '', next: '', name: '入量内容', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
  ...
  { key: 'nausea', event: keyf1, value: '', next: '', name: '恶心', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'vomiting', event: keyf1, value: '', next: '', name: '呕吐', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'dizzy', event: keyf1, value: '', next: '', name: '头晕', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'headache', event: keyf1, value: '', next: '', name: '头痛', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'monitoring', event: keyf1, value: '', next: '', name: '心电监护', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'ache', event: keyf1, value: '', next: '', name: '疼痛', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
