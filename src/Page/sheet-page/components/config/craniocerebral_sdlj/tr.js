...
export default [
  ...
  { key: 'reflectionLeft', event: keyf1, value: '', next: '', name: '瞳孔反射左', autoComplete: { data: ['灵敏√','迟钝+','消失－'],dataVal:['√','+','-'] }, textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'reflectionRight', event: keyf1, value: '', next: '', name: '瞳孔反射右', autoComplete: { data: ['灵敏√','迟钝+','消失－'],dataVal:['√','+','-']}, textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
