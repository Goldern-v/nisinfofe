...
import {
  ...
  export default [
    ...
    },
    {
      ...
      name: '左眼痛',
      next: '',
      autoComplete: { data: ['无','轻','中','重']},
      textarea:{ width:32},
      change: (e, td) => limitChange(e, td, 4)
    },
    {
      key: "eyePainRight", //右眼痛
      value: "",
      event: keyf1,
      name: '右眼痛',
      next: '',
    ...
    {
      key: "tearsLeft", //畏光、流泪左
      value: "",
      event: keyf1,
      name: '畏光、流泪左',
      next: '',
      autoComplete: { data: ['无','异常']},
      textarea:{ width:32},
      change: (e, td) => limitChange(e, td, 4)
    },
    {
      key: "tearsRight", //畏光、流泪右
      value: "",
      event: keyf1,
      name: '畏光、流泪右',
      next: '',
    ...
    {
      key: "woundDressing", //伤口敷料
      value: "",
      event: keyf1,
      name: '伤口敷料',
      next: '',
      autoComplete: { data: ['清洁','渗血','渗液']},
      textarea:{ width:32},
      change: (e, td) => limitChange(e, td, 4)
    },
    {
