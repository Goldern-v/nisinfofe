...
export default [
  ...
  { key: 'sputumProperties', event: keyf1, value: '', next: '', name: '痰液性质', autoComplete: { data: ['WL','YWT','YT','B'] }, textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'sputumVolume', event: keyf1, value: '', next: '', name: '痰液量', autoComplete: { data: ['+','++','+++'] }, textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'expectoration', event: keyf1, value: '', next: '', name: '排痰', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'sputum', event: keyf1, value: '', next: '', name: '吸痰', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'backslapLeft', event: keyf1, value: '', next: '', name: '翻身拍背左', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'backslapRight', event: keyf1, value: '', next: '', name: '翻身拍背右', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
