...
export default [
  ...
  { key: 'pupilSizeLeft', event: keyf1, value: '', next: '', name: '吸氧方式', autoComplete: { data: ['①', '②', '③', '④'] }, textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'customItem2', event: keyf1, value: '', next: '', name: '小便', textarea: { width: 35 }, autoComplete: { data: ['①', '②', '③', '④', '⑤'] }, change: (e, td) => limitChange(e, td, 4) },
