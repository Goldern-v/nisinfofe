...
export default [
  ...
  { key: 'consciousness', event: keyf1, value: '', next: '', name: '意识', autoComplete: { data: ['①', '②', '③', '④', '⑤', '⑥'] }, splice: '/', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'pupilSizeLeft', event: keyf1, value: '', next: '', name: '吸氧方式', autoComplete: { data: ['①', '②', '③', '④'] }, textarea: { width: 30 }, splice: '/', change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'skin', event: keyf1, value: '', next: '', name: '清洁护理', autoComplete: { data: ['①', '②', '③', '④', '⑤'] },textarea: { width: 35 }, splice: '/', change: (e, td) => limitChange(e, td, 4) },
  // { key: 'plumbing', event: keyf1, value: '', next: '', name: '管道护理', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'tracheal', event: keyf1, value: '', next: '', name: '气道护理', autoComplete: { data: ['①', '②', '③'] }, textarea: { width: 35 }, splice: '/', change: (e, td) => limitChange(e, td, 4) },
  { key: 'sputum', event: keyf1, value: '', next: '', name: '物理降温', autoComplete: { data: ['①', '②', '③', '④'] },textarea: { width: 35 }, splice: '/', change: (e, td) => limitChange(e, td, 4) },
  { key: 'careOther', event: keyf1, value: '', next: '', name: '饮食护理',autoComplete: { data: ['①', '②', '③', '④'] }, textarea: { width: 35 }, splice: '/', change: (e, td) => limitChange(e, td, 4) },
  { key: 'customItem1', event: keyf1, value: '', next: '', name: '大便', textarea: { width: 35 }, autoComplete: { data: ['①', '②', '③', '④', '⑤'] }, splice: '/', change: (e, td) => limitChange(e, td, 4) },
  { key: 'customItem2', event: keyf1, value: '', next: '', name: '小便', textarea: { width: 35 }, autoComplete: { data: ['①', '②', '③', '④', '⑤'] }, splice: '/', change: (e, td) => limitChange(e, td, 4) },
  { key: 'customItem3', event: keyf1, value: '', next: '', name: '咳嗽', textarea: { width: 35 }, autoComplete: { data: ['①', '②', '③'] }, splice: '/', change: (e, td) => limitChange(e, td, 4) },
  { key: 'customItem4', event: keyf1, value: '', next: '', name: '痰液性质', textarea: { width: 35 }, autoComplete: { data: ['①', '②', '③', '④', '⑤', '⑥', '⑦'] }, splice: '/', change: (e, td) => limitChange(e, td, 4) },
