...
let shaoOrzhDuo = ['正常','泌乳不足','乳汁过多']
let shangkou = ['干洁','红肿','渗液','水肿','正常','渗血']
let shangkouHuiYin = ['干洁','红肿','渗液','水肿','正常','渗血','裂伤']
...
const breastCondition = ["无肿胀","乳房肿胀","乳头疼痛","乳管堵塞","乳房感染","乳头血性分泌物"];
const uterineContractions = ["良好","乏力"];
const outputContent = ["尿", "引流液", "大便", "呕吐物", "恶露", "24h恶露", "阴道出血", "术中出血","恶露量"]
const pangguang = ['空虚','轻度充盈','中度充盈','重度充盈']
...
export default [
  ...
  { key: 'breastCondition', event: keyf1, value: '', next: '', name: '乳房情况', autoComplete: { data: breastCondition },textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) },
  ...
  { key: 'perineum', event: keyf1, value: '', next: '', name: '伤口会阴', autoComplete: { data: shangkouHuiYin }, textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
