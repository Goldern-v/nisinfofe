...
export default [
  ...
  { key: 'defecateFrequency', event: keyf1, value: '', next: '', name: '大便次数', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'numberUrine', event: keyf1, value: '', next: '', name: '小便次数', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'reactionwell', event: keyf1, value: '', next: '', name: '反应好', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'cryingBig', event: keyf1, value: '', next: '', name: '哭声大', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'cryingWeak', event: keyf1, value: '', next: '', name: '哭声微弱', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'suckinglWell', event: keyf1, value: '', next: '', name: '吮吸力好', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'suckinglMediocre', event: keyf1, value: '', next: '', name: '吮吸力一般', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'suckinglDifference', event: keyf1, value: '', next: '', name: '吮吸力差', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'nature', event: keyf1, value: '', next: '', name: '性质', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  ...
  { key: 'skinColor', event: keyf1, value: '', next: '', name: '皮肤颜色', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'elastic', event: keyf1, value: '', next: '', name: '弹性', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'rashPosition', event: keyf1, value: '', next: '', name: '皮疹位置', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'natureDegree', event: keyf1, value: '', next: '', name: '性质程度', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'tumorLocation', event: keyf1, value: '', next: '', name: '产瘤位置', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'size', event: keyf1, value: '', next: 'cm', name: '产瘤大小', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'hematomaHead', event: keyf1, value: '', next: '', name: '头部血肿位置', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'size2', event: keyf1, value: '', next: 'cm', name: '头部血肿大小', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'hipNursing', event: keyf1, value: '', next: '', name: '臀部护理', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'spa', event: keyf1, value: '', next: '', name: '水疗', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'touch', event: keyf1, value: '', next: '', name: '抚触', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'navelNursing', event: keyf1, value: '', next: '', name: '脐部护理', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'transdermalBilirubin', event: keyf1, value: '', next: '', name: '经皮胆红素测定额', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'chest', event: keyf1, value: '', next: '', name: '经皮胆红素测定胸', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
