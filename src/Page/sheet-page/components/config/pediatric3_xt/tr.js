...
export default [
  ...
  { key: 'daXiao', event: keyf1, value: '', next: 'cm', name: '产瘤大小', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'daXiao2', event: keyf1, value: '', next: 'cm', name: '头部血肿大小', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
