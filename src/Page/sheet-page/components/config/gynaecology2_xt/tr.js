...
export default [
  ...
  { key: 'nausea', event: keyf1, value: '', next: '', name: '恶心', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'vomiting', event: keyf1, value: '', next: '', name: '呕吐', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'abdominalDistension', event: keyf1, value: '', next: '', name: '腹胀', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'anusBelly', event: keyf1, value: '', next: '', name: '肛门坠胀', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'abdominalPain', event: keyf1, value: '', next: '', name: '腹痛部位', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'degree', event: keyf1, value: '', next: '', name: '腹痛程度', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'lumbosacralTenderness', event: keyf1, value: '', next: '', name: '腰骶部胀痛', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'vaginalDischarge', event: keyf1, value: '', next: '', name: '阴道分泌物情况', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'vaginalBleeding', event: keyf1, value: '', next: 'ml', name: '阴道出血', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'bleedingColor', event: keyf1, value: '', next: '', name: '阴道出血颜色', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 2) },
