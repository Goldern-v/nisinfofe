...
export default [
  ...
  { key: 'hipSwelling', event: keyf1, value: '', next: '', name: '患髋肿胀', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6), autoComplete:{data:["无","I°","II°","III°"]} },
  ...
  { key: 'jointAvtivities', event: keyf1, value: '', next: '', name: '患髋活动', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6),autoComplete:{data:["自如","受限"]}},
  { key: 'cllBell', event: keyf1, value: '', next: '', name: '呼叫铃置可及处', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) , autoComplete:{data:["√","无","有"]}},
  { key: 'walkingUse', event: keyf1, value: '', next: '', name: '助兴器使用', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) , autoComplete:{data:["无","有"]}},
  { key: 'fallPrevention', event: keyf1, value: '', next: '', name: '防跌倒宣教', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) , autoComplete:{data:["无","有"]}},
  { key: 'limbFeeling', event: keyf1, value: '', next: '', name: '患肢各趾感觉', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6), autoComplete:{data:["麻木","正常","减弱","消失"]} },
  ...
  { key: 'limbDorsalis', event: keyf1, value: '', next: '', name: '患肢足背动脉搏动', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6), autoComplete:{data:["明显","减弱","消失"]} },
