...
export default [
  ...
  { key: 'JointActivities', event: keyf1, value: '', next: '', name: '患髋活动', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6),autoComplete:{data:["自如","受限"]}},
  ...
  { key: 'limbFeeling', event: keyf1, value: '', next: '', name: '患肢各趾感觉', textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6), autoComplete:{data:["无","有"]} },
