...
export default [
  ...
  { key: 'vaginalBleeding', event: keyf1, value: '', next: 'ml', name: '阴道出血', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
  { key: 'urine', event: keyf1, value: '', next: 'ml', name: '尿量', textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 4) },
  ...
  { key: 'contractionsSoft', event: keyf1, value: '', next: '', name: '软', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 1) },
  { key: 'contractionsHard', event: keyf1, value: '', next: '', name: '硬', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 1) },
  ...
  { key: 'nursingMeasures', event: keyf1, value: '', next: '', name: '护理措施', autoComplete: { data: safeList },splice:true, textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'nursingSafety', event: keyf1, value: '', next: '', name: '护理安全', autoComplete: { data: measureList },splice:true, textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 4) },
  {
