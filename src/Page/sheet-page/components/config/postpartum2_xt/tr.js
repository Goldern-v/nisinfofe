...
export default [
  ...
  { key: 'contractionsHard', event: keyf1, value: '', next: '', name: '硬', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  ...
  { key: 'armValue1', event: keyf1, value: '', next: '', name: '', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  ...
  { key: 'urinaryRetention', event: keyf1, value: '', next: '', name: '预防尿潴留', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
