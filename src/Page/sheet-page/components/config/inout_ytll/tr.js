...
export default [
  ...
  { key: 'food', event: keyf1, value: '', next: '', name: '项目', textarea: { width: 80 }, change: (e, td) => limitChange(e, td, 12) },
  { key: 'foodSize', event: keyf1, value: '', next: '', name: '实入量', textarea: { width: 80 }, change: (e, td) => limitChange(e, td, 12) },
