...
export default [
  ...
  { key: 'heartRhythm', event: keyf1, value: '', next: '', name: '心律',textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 7) },
  ...
  { key: 'costom6', event: keyf1, value: '', next: '', name: '',textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
  {
