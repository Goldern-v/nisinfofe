...
const pwList = [{ name: 'A=温暖', value: 'A' }, { name: 'B=低于健侧', value: 'B' }, { name: 'C=稍低于健侧', value: 'C' }, { name: 'D=冰凉', value: 'D' }, { name: 'D=高于健侧；', value: 'D' }]
...
const sgList = [{ name: 'A=过紧', value: 'A' }, { name: 'B=少过松', value: 'B' }, { name: 'C=合适', value: 'C' }]
const qyList = [{ name: 'A=过紧', value: 'A' }, { name: 'B=少过松', value: 'B' }, { name: 'C=合适', value: 'C' }]
...
export default [
  ...
  { key: 'limbLength', event: keyf1, value: '', next: '', name: '患肢/健肢长度', textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
