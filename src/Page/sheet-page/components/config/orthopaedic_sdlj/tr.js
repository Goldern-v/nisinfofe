...
export default [
  ...
  { key: 'position', event: keyf1, value: '', next: '', name: '体位', autoComplete: { data: ['A','B','C','D'] }, textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'color', event: keyf1, value: '', next: '', name: '颜色', autoComplete: { data: ['A','B','C','D','E','F','G'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: '', event: keyf1, value: '', next: '', name: '皮温', autoComplete: { data: ['A','B','C','D','E'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'swelling', event: keyf1, value: '', next: '', name: '肿胀', autoComplete: { data: ['A','B','C','D'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'feeling', event: keyf1, value: '', next: '', name: '感觉', autoComplete: { data: ['A','B','C','D'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'activity', event: keyf1, value: '', next: '', name: '活动', autoComplete: { data: ['A','B','C','D','E'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'capillary', event: keyf1, value: '', next: '', name: '毛细血管反应', autoComplete: { data: ['A','B','C','D'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'artery', event: keyf1, value: '', next: '', name: '动脉搏动', autoComplete: { data: ['A','B','C'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'integrity', event: keyf1, value: '', next: '', name: '皮肤完整性', autoComplete: { data: ['A','B','C','D'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'measures', event: keyf1, value: '', next: '', name: '护理措施', splice: '/', autoComplete: { data: ['A','B','C','D','E','F'] },  textarea: { width: 40 }, change: (e, td) => limitChange(e, td, 5) },
  { key: 'armValue', event: keyf1, value: '', next: '', name: '', textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'dressing', event: keyf1, value: '', next: '', name: '伤口敷料', autoComplete: { data: ['A','B','C'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'functional', event: keyf1, value: '', next: '', name: '功能锻炼', splice: '/', autoComplete: { data: ['A','B','C','D','E','F','G','H','I','J'] },  textarea: { width: 65 }, change: (e, td) => limitChange(e, td, 10) },
  { key: 'gypsum', event: keyf1, value: '', next: '', name: '石膏', autoComplete: { data: ['A','B','C'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'traction', event: keyf1, value: '', next: '', name: '牵引', autoComplete: { data: ['A','B','C'] },  textarea: { width: 27 }, change: (e, td) => limitChange(e, td, 2) },
  {
