...
export default [
  ...
  { key: 'limbLength', event: keyf1, value: '', next: '', name: '患肢/健肢长度', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 6) },
  ...
  { key: 'dressing', event: keyf1, value: '', next: '', name: '伤口敷料', autoComplete: { data: flList },  textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'gypsum', event: keyf1, value: '', next: '', name: '石膏', autoComplete: { data: sgList },  textarea: { width: 30 }, change: (e, td) => limitChange(e, td, 2) },
