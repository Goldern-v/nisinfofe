...
export default [
  ...
  { key: 'pupilSizeLeft', event: keyf1, value: '', next: 'mm', name: '瞳孔大小左', textarea: { width: 15 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'pupilSizeRight', event: keyf1, value: '', next: 'mm', name: '瞳孔大小右', textarea: { width: 15 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'pupilReflectionLeft', event: keyf1, value: '', next: '', name: '瞳孔反射左', autoComplete: { data: dgfyList }, textarea: { width: 15 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'pupilReflectionRight', event: keyf1, value: '', next: '', name: '瞳孔反射右', autoComplete: { data: dgfyList }, textarea: { width: 15 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'food', event: keyf1, value: '', next: '', name: '入量内容', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'foodSize', event: keyf1, value: '', next: 'ml', name: '量', textarea: { width: 15 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'discharge', event: keyf1, value: '', next: '', name: '出量内容', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'dischargeSize', event: keyf1, value: '', next: 'ml', name: '出量', textarea: { width: 15 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'respiratorySymptoms', event: keyf1, value: '', next: '', autoComplete: { data: shxdList }, name: '上呼吸道症状', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'armValue3', event: keyf1, value: '', next: '', name: '', autoComplete: { data: tyList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'cough', event: keyf1, value: '', next: '', name: '咳嗽', autoComplete: { data: ksList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'coughingPhlegm', event: keyf1, value: '', next: '', name: '咳痰', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'sputumProperties', event: keyf1, value: '', next: '', name: '痰液性质', autoComplete: { data: tyxzList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'sputumVolume', event: keyf1, value: '', next: '', name: '痰量', autoComplete: { data: tlList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  ...
  { key: 'armValue22', event: keyf1, value: '', next: '', name: '', autoComplete: { data: tyList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'indwellingNeedle', event: keyf1, value: '', next: '', name: '留置针部位', autoComplete: { data: lzzbwList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'needleCondition', event: keyf1, value: '', next: '', name: '留置针情况', autoComplete: { data: lzzqkList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'pipeNursing', event: keyf1, value: '', next: '', name: '冲管护理', textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'armValue24', event: keyf1, value: '', next: '', name: '', autoComplete: { data: tyList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'armValue25', event: keyf1, value: '', next: '', name: '', autoComplete: { data: tyList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'armValue26', event: keyf1, value: '', next: '', name: '', autoComplete: { data: tyList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'armValue27', event: keyf1, value: '', next: '', name: '', autoComplete: { data: tyList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'nursingMeasures', event: keyf1, value: '', next: '', name: '护理措施', autoComplete: { data: hlcsList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
  { key: 'nursingSafety', event: keyf1, value: '', next: '', name: '护理安全', autoComplete: { data: hlaqList }, textarea: { width: 20 }, change: (e, td) => limitChange(e, td, 2) },
