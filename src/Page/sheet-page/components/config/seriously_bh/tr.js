...
import {
  ...
  export default [
    ...
    { key: 'outputName', event: keyf1, value: '', next: '', name: '出量', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8),autoComplete: { data: ['尿量','大便','心包引流','纵膈引流','胃液','呕吐液','胃造瘘','左引流液','左胸液','右胸液','上胸液','下胸液','痰液','头部引流液'] } },
