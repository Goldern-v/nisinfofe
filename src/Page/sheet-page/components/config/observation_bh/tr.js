...
import {
  ...
  export default [
    ...
    { key: 'foodSize', event: keyf1, value: '', next: 'ml', name: '入量量', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
    { key: 'discharge', event: keyf1, value: '', next: '', name: '出量', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
    { key: 'dischargeSize', event: keyf1, value: '', next: 'ml', name: '出量量', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8) },
