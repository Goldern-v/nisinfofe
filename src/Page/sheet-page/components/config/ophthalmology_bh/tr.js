...
import {
  ...
  export default [
    ...
    { key: 'outputAmount', event: keyf1, value: '', next: 'ml', name: '入量量', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
    { key: 'outputName', event: keyf1, value: '', next: '', name: '出量', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8),autoComplete: { data: ['尿量','大便','胃液','胆汁','胰液','肠液','呕吐液','胃造瘘','左引流液','腹腔引流','左胸液','右胸液','上胸液','下胸液','盆腔引流','痰液','头部引流液'] } },
    { key: 'outputQuantity', event: keyf1, value: '', next: 'ml', name: '出量量', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4) },
    { key: 'outputColor', event: keyf1, value: '', next: '', name: '出量颜色', textarea: { width: 35 }, change: (e, td) => limitChange(e, td, 4),autoComplete: { data: ['黄白色','血丝色','血色','淡青色','棕色','奶油色','灰色','绿色','粉红色','淡粉色','黄褐色','白色','黄色'] } },
    ...
    { key: 'watchParts', event: keyf1, value: '', next: '', name: '管道',textarea: { width: 160 }, change: (e, td) => limitChange(e, td, 26),autoComplete: { data: ['无','导尿管','胃管','深静脉导管','浅静脉留置针','胸腔引流管','气切','气管插管','气切套管','脑室引流管','硬膜下引流管','硬膜外引流管'] },splice:true},
