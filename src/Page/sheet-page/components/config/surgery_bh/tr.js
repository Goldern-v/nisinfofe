...
import {
  ...
  export default [
    ...
    { key: 'outputName2', event: keyf1, value: '', next: '', name: '出量', textarea: { width: 50 }, change: (e, td) => limitChange(e, td, 8),autoComplete: { data: ['尿量','大便','胃液','胆汁','胰液','肠液','呕吐液','胃造瘘','左引流液','腹腔引流','左胸液','右胸液','上胸液','下胸液','盆腔引流','痰液','头部引流液'] } },
