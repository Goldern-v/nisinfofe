...
export default [
  ...
  { key: 'bloodPressure1', event: keyf1, value: '', next: '℃', name: '体温', textarea: { width: 40 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'bloodPressure2', event: keyf1, value: '', next: '次/分', name: '脉搏', textarea: { width: 40 }, change: (e, td) => limitChange(e, td, 5) },
  { key: 'bloodPressure3', event: keyf1, value: '', next: '次/分', name: '呼吸', textarea: { width: 40 }, change: (e, td) => limitChange(e, td, 5) },
  { key: 'bloodPressure4', event: keyf1, value: '', next: 'L/min', name: '吸氧', textarea: { width: 40 }, change: (e, td) => limitChange(e, td, 5) },
