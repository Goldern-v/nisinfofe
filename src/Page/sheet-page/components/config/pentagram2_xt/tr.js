...
export default [
  ...
  { key: 'pupilReflectionLeft', event: keyf1, value: '', next: '', name: '瞳孔反射左', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'pupilReflectionRight', event: keyf1, value: '', next: '', name: '瞳孔反射右', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  ...
  { key: 'armValue5', event: keyf1, value: '', next: '', name: '', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'armValue6', event: keyf1, value: '', next: '', name: '', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'armValue7', event: keyf1, value: '', next: '', name: '', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'armValue8', event: keyf1, value: '', next: '', name: '', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'armValue9', event: keyf1, value: '', next: '', name: '', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'armValue10', event: keyf1, value: '', next: '', name: '', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
  { key: 'armValue11', event: keyf1, value: '', next: '', name: '', textarea: { width: 25 }, change: (e, td) => limitChange(e, td, 4) },
