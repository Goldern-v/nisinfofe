...
export default [
  ...
  { key: 'custom', event: keyf1, value: '',textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) , autoComplete:{data:["中","低","高","禁食","轻","中","重"]}},
  ...
  { key: 'customValue2', event: keyf1, value: '',textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) , autoComplete:{data:["中","低","高","禁食","轻","中","重"]}},
  { key: 'customValue3', event: keyf1, value: '',textarea: { width: 45 }, change: (e, td) => limitChange(e, td, 6) , autoComplete:{data:["中","低","高","禁食","轻","中","重"]}},
  {
