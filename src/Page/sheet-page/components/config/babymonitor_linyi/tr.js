...
export default [
  ...
  { key: 'nameMethod', event: keyf1, value: '', next: '', name: '注射药名及用法',textarea: { width: 135 }, change: (e, td) => limitChange(e, td, 4) },
  ...
  { key: 'species', event: keyf1, value: '', next: '', name: '奶种类', autoComplete:{data:['①','②','③','④']} },
  { key: 'administration', event: keyf1, value: '', next: '', name: '口服药', textarea: { width: 32 }, change: (e, td) => limitChange(e, td, 4),  },
  { key: 'inputMethod', event: keyf1, value: '', next: '', name: '喂入方式',textarea: { width: 50 },  autoComplete:{data:['①','②','③']} },
