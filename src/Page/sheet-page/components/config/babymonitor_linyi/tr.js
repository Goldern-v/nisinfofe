...
export default [
  ...
  { key: 'species', event: keyf1, value: '', next: '', name: '奶种类', autoComplete:{data:['①足月配方奶','②早产儿配方奶','③母乳','④无乳糖配方奶']} },
  { key: 'administration', event: keyf1, value: '', next: '', name: '口服药', textarea: { width: 32 }, change: (e, td) => limitChange(e, td, 4),  },
  { key: 'inputMethod', event: keyf1, value: '', next: '', name: '喂入方式',textarea: { width: 50 },  autoComplete:{data:['①口入','②胃管','③先口入后胃管']} },
  ...
  { key: 'nursingMeasures', event: keyf1, value: '', next: '℃', name: '护理措施', textarea: { width: 32 }, change: (e, td) => limitChange(e, td, 4),  },
  {
