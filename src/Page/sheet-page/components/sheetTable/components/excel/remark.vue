<template>
  <div class="bottomRemark">
    ...
    <!-- 外科 -->
    <!-- <div v-if="sheetInfo.sheetType == 'tcm_pediatrics_jm'">
      <p>
        <b>体温异常措施：</b>①适量增加饮水量（ml） ②温水擦浴 ③冰块冷敷 ④遵医嘱药物治疗
        ⑤减少盖被 血压异常处理：①遵医嘱应用药物 ②观察做好宣教
      </p>
      <p>
        <b>氧疗：</b>①鼻导管 ②面罩 ③双鼻塞 <b>术前准备：</b>①备皮 ②术前禁饮食 ③术前插胃管
        ④术前插鼻肠管 ⑤肌注术前针 ⑥术前心理护理
      </p>
      <p>
      ...
      <p><b>疼痛护理：</b>①非药物治疗 ②遵医嘱用药 腹部症状采取措施①腹部按摩 ②用药</p>
      <p>
        <b>采取措施后效果：</b>①好 ②差 <b>呼吸道管理：</b>①指导有效咳嗽及深呼吸 ②协助扣背排痰
        ③排痰机排痰 ④吸痰 ⑤ 雾化吸入
      </p>
      <p>
        <b>睡眠：</b>①安静休息 ②间断入眠 ③入睡困难 ④暗化病室 ⑤应用药物 ⑥其它
        <b>患者依从性</b>：①好 ②一般 ③差 <b>自理能力：</b>①完全自理 ②部分协助 ③全部协助
      </p>
      <p>
