...
注：1、神志：清醒√、嗜睡+、昏睡、浅昏迷++、深昏迷+++、模糊、谵妄、植物状态A、睁眼昏迷B        2、瞳孔观察—瞳孔对光反应：灵敏√  迟钝+  消失++
  ...
  <div class="bottomRemark">
    ...
    <div v-if="sheetInfo.sheetType == 'common_hd'">
   ...
   <!-- 顺德人医-产后产房观察记录单 -->
    ...
    <div v-if="sheetInfo.sheetType == 'record_common_sdhp'">
      备注:1、意识:清醒(一)嗜睡+浅昏迷++ 深昏迷+++  2、瞳孔对光反应:灵敏了 )迟钝+消失++ <br>
      3、患肢肿胀:无(一)  I度肿胀:轻微肿胀，皮纹还在；Ⅱ度肿胀:明显肿胀，皮纹消失；Ⅲ度肿胀:皮肤上有凹坑且皮纹消失，且张力性水疱。 <br>
