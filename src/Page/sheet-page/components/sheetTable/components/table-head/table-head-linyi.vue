<template>
  <div class="header-con">
    ...
    <div class="info-con" flex="main:justify">
      ...
      <span>
        科室：
        <div v-if="sheetInfo.sheetType == 'critical_new_linyi' || sheetInfo.sheetType == 'critical_new_weihai' || sheetInfo.sheetType == 'baby2_weihai'" class="bottom-line" style="min-width: 120px">{{patientInfo.realDeptName}}</div>
      ...
      <span>
       ...
       <span v-if="sheetInfo.sheetType == 'critical_new_linyi' || sheetInfo.sheetType == 'critical_new_weihai' || sheetInfo.sheetType == 'baby2_weihai'">入院日期：<div class="bottom-line" style="min-width: 50px">{{patientInfo.admissionDate | toymd}}</div></span>
    </div>
    <div class="info-con" flex="main:justify">
      <span
        @click="updateDiagnosis('diagnosis', '诊断', patientInfo.diagnosis)"
        v-if="sheetInfo.sheetType == 'critical_new_linyi' || sheetInfo.sheetType == 'critical_new_weihai' || sheetInfo.sheetType == 'baby2_weihai'"
      >
        诊断：
        <div
          class="bottom-line"
