<template>
  <div class="header-con">
    ...
    <div class="info-con" flex="main:justify" v-else>
      ...
      <span v-if="['critical_new_weihai','baby2_weihai', 'internal_eval_weihai', 'inandout_weihai','baby_weihai', 'extracardi_one_weihai', 'extracardi_two_weihai', 'extracardi_three_weihai'].includes(sheetInfo.sheetType)">
        入院日期：
