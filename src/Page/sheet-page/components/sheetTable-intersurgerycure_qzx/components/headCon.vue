    ...
    <div class="info-con">
      ...
      <span>
        ...
        <div
          class="bottom-line"
          style="min-width: 50px"
          @click="updateTetxInfo('inpNo', '病例号', patientInfo.inpNo)"
        >
          {{ patientInfo.inpNo }}
        </div>
      </span>
      <!-- <span>
        ...
        <div
          class="bottom-line"
          style="min-width: 50px"
          @click="updateTetxInfo('operationName', '手术名称', patientInfo.operationName)"
        >
          {{ patientInfo.caseNo }}
        </div>
      </span>
      <span>
        ...
        <div
          class="bottom-line"
          style="min-width: 50px"
          @click="updateTetxInfo('remark', '备注', patientInfo.remark)"
        >
          {{ patientInfo.remark }}
        </div>
      </span> -->
