...
export let recordsHead = [
  ...
  { label: "外露/置管长度", type: "String", width: "5%" },
  { label: "手臂周长", type: "String", width: "5%" },
  { label: "换敷贴", type: "String", width: "5%" },
  { label: "冲管", type: "String", width: "5%" },
  { label: "换肝素冒", type: "String", width: "8%" },
  { label: "置管局部情况", type: "String", width: "200px" },
