<template>
  <div>
    ...
    >
      <div style="margin-bottom: 20px">
        <el-tabs type="card" @tab-click="handleClick" v-model="activeName">
          <el-tab-pane label="纯标题模板" style="display: flex;" name="first">
            <div class="tab-list-item" v-if="['nfyksdyy','whhk','foshanrenyi','zjhj','hzly','sdhpwk'].includes(this.HOSPITAL_ID)">
      ...
      <div
        slot="button"
        :style="isAddList ||['nfyksdyy','whhk','foshanrenyi','zjhj','hzly','sdhpwk'].includes(this.HOSPITAL_ID) ? 'display:flex; justify-content:space-between' : ''"
      >
        <el-button
          class="modal-btn"
          type="text"
