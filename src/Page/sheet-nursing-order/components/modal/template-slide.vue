<template>
  <div>
    ...
    <addTemplateModal :formCode="formCode" ref="addTemplateModal"></addTemplateModal>
  </div>
</template>
...
import { typeList, list } from "@/Page/sheet-nursing-order/api/recordDesc.js";
...
export default {
  ...
  methods: {
    open(formCode='') {
      ...
      console.log('open:template-slide',this.formCode)
      this.getData();
      this.show = true;
    ...
    getData() {
      typeList(this.formCode).then(res => {
        this.typeList = res.data.data.list;
        if (this.selectedType) {
          list(this.selectedType,this.formCode).then(res => {
