...
export function listShiftRecord(deptCode, startDate, endDate) {
  return axios.get(
    `${apiPath}changeShiftTimeHJ/list/${deptCode}/${startDate}/${endDate}`
  );
}

// 查询交班志
export function getShiftRecord(id) {
  return axios.get(`${apiPath}changeShiftTimeHJ/getById/${id}`);
}
...
export function createShiftRecord(
  ...
  return axios.post(`${apiPath}changeShiftTimeHJ/save`, {
    deptCode,
    changeShiftDate,
    copyChangeShift
  });
...
export function updateShiftRecord(data) {
  return axios.post(`${apiPath}changeShiftPatientHJList/saveOrUpdate`, data);
}

// 删除交班志行
export function removeShiftRecordRow(rowId) {
  return axios.get(`${apiPath}changeShiftPatientHJList/delete/${rowId}`);
}

// 删除交班志
export function removeShiftRecord(id, empNo, password) {
  return axios.get(
    `${apiPath}changeShiftTimeHJ/delById/${id}/${empNo}/${password}`
  );
}
...
export function signShiftRecord(id, AutographNameType, empNo, password) {
  return axios.get(
    `${apiPath}changeShiftTimeHJ/updateAutographName/${id}/${AutographNameType}/${empNo}/${password}`
  );
}
...
export function delSignShiftRecord(id, empNo, password, type, sourceEmpNo) {
  return axios.get(
    `${apiPath}changeShiftTimeHJ/updateAutographName/${id}/${empNo}/${password}/${type}/${sourceEmpNo}
    `
  );
}
...
export function getPatient(deptCode, bedLabel, date) {
  return axios.get(
    `${apiPath}changeShiftPatientHJList/findByBedLabel/${deptCode}/${bedLabel}/${date}`
  );
}
...
export function listPatients(deptCode, date, id) {
  return axios.get(
    `${apiPath}changeShiftPatientHJList/getShiftPatientALL/${deptCode}/${date}/${id}`
  );
}
