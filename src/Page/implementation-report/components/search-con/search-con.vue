<template>
  <div class="search-contain">
    <div class="search-box">
      ...
      <el-select placeholder="请选择" v-model="data.deptValue" filterable  @change="changeDept(data.deptValue)"> 
    ...
    <div class="search-box">
      ...
      <div class="select-box" flex="cross:stretch">
           <div class="select-item" flex="cross:center main:center" flex-box="1" style="border-right: 1px solid #C2CBD2">
    ...
    <div class="search-btn" flex="cross:center main:center" @click="search" v-touch-ripple>
      检索
    </div>
  </div>
</template>
  ...
  export default {
    ...
    created() {
      nursingUnit().then((res) => {
        ...
        this.data.deptValue = this.$store.state.lesion.deptCode || res.data.data.defaultDept || res.data.data.deptList[0].code
