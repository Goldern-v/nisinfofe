...
export function listShiftRecord(deptCode, startDate, endDate) {
  const params = {deptCode, startDate, endDate}
  return axios.post(`${apiPath}nightRounds/list`, params);
}

// 查询交班志
export function getShiftRecord(id) {
  return axios.get(`${apiPath}nightRounds/get/${id}`);
}

// 创建交班志
export function createShiftRecord(deptCode, roundsDate, remake = '') {
  // return axios.post(`${apiPath}eval/night_rounds_wj/save`, {
  return axios.post(`${apiPath}nightRounds/save`, {
    deptCode,
    roundsDate,
    remake
  });
...
export function updateShiftRecord(data) {
  return axios.post(`${apiPath}nightRounds/saveAll`, data);
}
...
export function removeShiftRecord(id, empNo, password) {
  return axios.post(`${apiPath}nightRounds/delete/${id}`);
}
