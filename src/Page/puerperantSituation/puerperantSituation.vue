...
export default {
  ...
  methods: {
    ...
    handleSearch() {
      if (this.query.pageIndex == 1) this.getTableData();
      else this.query.pageIndex = 1;
    },
    ...
    handleCellClick(record) {
      ...
      switch (column.key) {
        ...
        case "分娩时间-分":
          ...
          editType = "dateTime";
          if (
            moment(row[editName]).format("YYYY-MM-DD HH:mm:ss") ==
            "Invalid Date"
          )
            editValue = "";
          break;
      ...
      return h("el-input", {
        ...
        on: {
          blur: e => {
            ...
            this.handleChange(record, key, newVal, {
              reSumProductionProcess: true
            });
          }
        }
      });
        ...
        [
          h(
            "el-option",
            {
              ...
              nativeOn: {
                click: e =>
                  this.handleChange(record, key, "", { forceRender: true })
              }
            },
            ""
          ),
          options.map(item =>
            h("el-option", {
              ...
              nativeOn: {
                click: e => {
                  let val =
                    e.target.getAttribute("dataValue") || e.target.innerHTML;
