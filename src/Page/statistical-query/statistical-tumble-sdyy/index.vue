  ...
  <search-con
    ...
    <template>
      <div class="search-con__ctx__item">
        评分：
        <input-num-range
          :value="[formData.fallDownScoreMin, formData.fallDownScoreMax]"
          @change="(e) => handleIptNum(e,['fallDownScoreMin', 'fallDownScoreMax'])"
        />
      </div>
      <div class="search-con__ctx__item">
        年龄：
        <input-num-range
          :value="[formData.age1, formData.age2]"
          @change="(e) => handleIptNum(e,['age1', 'age2'])"
        />
      </div>
    </template>
  </search-con>
