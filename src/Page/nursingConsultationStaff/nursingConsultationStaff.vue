    ...
    <div class="content">
      <div class="select-nav">
        <div class="select-btn-con">
          <el-button class="select-btn" :class="{active: type=='科室发起的会诊'}" @click="type = '科室发起的会诊'">科室发起的会诊</el-button>
          <el-button class="select-btn" :class="{active: type=='邀请科室的会诊'}" @click="type = '邀请科室的会诊'">邀请科室的会诊</el-button>
        </div>
      ...
      <consultationTable :tableData="tableDataSelect" :conType="type" @refresh="refresh"></consultationTable>
      <div class="page-con">
        <el-pagination 
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getTableData() {
        deptList(this.type, this.status, this.tableInfo.pageIndex, this.tableInfo.pageSize).then((res) => {
