			...
			<el-dialog title="护理会诊单" :visible.sync="dialogFormVisible" :close-on-click-modal="false" :show-close="true" :before-close="beforeClose">
				...
				<el-form>
					...
					<el-form-item label="申请会诊目的" :label-width="formLabelWidth">
						<el-input type="textarea" :rows="1" placeholder="请输入内容" v-model="consultation.conGoal" :readonly="true">
						</el-input>
					</el-form-item>
					<el-form-item label="当前护理诊断" :label-width="formLabelWidth">
						<el-input type="textarea" :rows="1" placeholder="请输入内容" v-model="conDiag" :readonly="true">
						</el-input>
					</el-form-item>
				...
				<div slot="footer" class="dialog-footer" center v-if="conType != '科室发起的会诊'">
				...
				<div slot="footer" class="dialog-footer" center v-else>
					<el-button v-touch-ripple @click="close">关闭</el-button>
				</div>
			</el-dialog>
		</section>
		<!-- 人员弹窗 -->
