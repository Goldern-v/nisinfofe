export const formTypeList=[//不良事件类型
    ...
    {//20210926新表单
        ...
        childType:"实习带教",//具体表单内容类型
        funType:"type1",//类型
    },
    {//20210926新表单
        type:"烫伤单模板",//父表单，头部与尾部内容类型
        childType:"烫伤",//具体表单内容类型
        funType:"type1",//类型
    },
    {//20210926新表单
        type:"走失单模板",//父表单，头部与尾部内容类型
        childType:"走失",//具体表单内容类型
        funType:"type1",//类型
    },
    //20211012 childType带上不良事件
    {//20210926新表单
        type:"标本采集单模板",//父表单，头部与尾部内容类型
