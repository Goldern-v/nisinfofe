    ...
    <div class="main-contain">
      <div class="head-con">
        ...
        <div>
          ...
          <span
            class="label"
            v-if="['sdlj', 'lyxrm', 'ytll', 'whhk'].includes(HOSPITAL_ID)"
            >途径:</span
          >
          <el-autocomplete
            v-if="['sdlj', 'lyxrm', 'ytll', 'whhk'].includes(HOSPITAL_ID)"
      ...
      <div class="new-print-box" id="new-print-box" ref="new_print_modal">
        ...
        <div
          :class="[
            {
              'break-page':
                ['lyxrm', 'whhk'].includes(HOSPITAL_ID) &&
                bottleCardIndex % 3 == 2 &&
                newModalSize == '3*7',
            },
          ]"
...
const initStartDate = () => {
  if (
    ["whfk", "fsxt", "lyxrm", "whhk", "ytll"].includes(process.env.HOSPITAL_ID)
  )
...
export default {
  ...
  data() {
    return {
      ...
      query: {
        wardCode: "",
        itemType: ["whfk", "lyxrm", "whhk"].includes(this.HOSPITAL_ID)
          ? "全部"
          : "输液", //医嘱类别，输液、雾化
  ...
  methods: {
    ...
    async newOnPrint() {
      ...
      if (
        ["sdlj", "gdtj", "fsxt", "lyxrm", "whfk", "ytll", "whhk"].includes(
          this.HOSPITAL_ID
        )
      ) {
