  ...
  <div class="d-table">
    <u-table
     ...
     >
      ...
      <u-table-column label="摆药人" prop="beiNurse" min-width="200px" align="center" v-show="selectedData.executeType">
      <template slot-scope="scope">
          <span :title="scope.row.beiNurse">{{scope.row.beiNurse}}</span>
        </template>
      </u-table-column>
      <u-table-column label="摆药时间" prop="beiTime" min-width="200px" align="center"  v-show="selectedData.executeType">
      <template slot-scope="scope">
          <span :title="scope.row.beiTime">{{scope.row.beiTime}}</span>
        </template>
      </u-table-column>
      <u-table-column label="配药人" prop="dispenseNurse" min-width="200px" align="center"  v-show="selectedData.executeType">
      <template slot-scope="scope">
          <span :title="scope.row.dispenseNurse">{{scope.row.dispenseNurse}}</span>
        </template>
      </u-table-column>
      <u-table-column label="配药时间" prop="dispenseDateTime" min-width="200px" align="center"  v-show="selectedData.executeType">
      <template slot-scope="scope">
          <span :title="scope.row.dispenseDateTime">{{scope.row.dispenseDateTime}}</span>
        </template>
      </u-table-column>
      <u-table-column label="核对人" prop="dispenseVerifyNurse" min-width="200px" align="center"  v-show="selectedData.executeType">
      <template slot-scope="scope">
          <span :title="scope.row.dispenseVerifyNurse">{{scope.row.dispenseVerifyNurse}}</span>
        </template>
      </u-table-column>
      <u-table-column label="核对时间" prop="dispenseVerifyDateTime" min-width="200px" align="center"  v-show="selectedData.executeType">
      <template slot-scope="scope">
