...
export function updateShiftRecord(data) {
  return axios.post(`${apiPath}changeShiftPatientListWJ/saveOrUpdate`, data);
}
export function updateShiftRecordByWujing(data) {
  return axios.post(`${apiPath}/changeShiftPatientListWJ/saveOrUpdate`, data)
}

// 删除交班志行
export function removeShiftRecordRow(rowId) {
  return axios.get(`${apiPath}changeShiftPatientListWJ/delete/${rowId}`);
}
...
// 更新交班列签名
export function signShiftRecordByRow(id, empNo, password) {
  return axios.post(
    `${apiPath}changeShiftPatientListWJ/updateSignature` , {id, empNo, password});
}

// 取消交班列签名
export function delSignShiftRecordByRow(id, empNo, password, sourceEmpNo) {
  return axios.get(
    `${apiPath}changeShiftPatientListWJ/updateAutographName/${id}/${empNo}/${password}/${sourceEmpNo}`
  );
}
