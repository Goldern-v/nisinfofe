<template>
  <div class="contain">
    ...
    <page2></page2>-->
    <div class="page" v-if="HOSPITAL_ID == 'beihairenyi'">
       <leftBeihai></leftBeihai>
    </div>
    <div :class="['page',HOSPITAL_ID == 'wujing'?'wujing':'']" flex>
      <div class="left-part" flex-box="6">
        <left1></left1>
        <div style="height: 20px"></div>
        <left2 v-if="HOSPITAL_ID !== 'beihairenyi'"></left2>
        <div style="height: 20px"></div>
        <left3></left3>
      </div>
...
import leftBeihai from "./left-part/leftBeihai.vue";
