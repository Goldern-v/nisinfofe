  ...
  <div class="diagnosis-table">
    <div class="edit-table">
      ...
      >
        ...
        <el-table-column label="护理措施计划" min-width="140px" header-align="center">
          <template slot-scope="scope">
            <div>
        ...
        <el-table-column label="护理目标" min-width="140px" header-align="center">
          <template slot-scope="scope">
            <div>
        ...
        <el-table-column label="操作" width="135" header-align="center">
          <template slot-scope="scope">
            <div class="tool-con">
              <div
              ...
              <div v-if="['huadu'].includes(HOSPITAL_ID)" :style="{textAlign:'center'}">开嘱人：{{scope.row.creatorName}}</div>
              <div v-if="['huadu'].includes(HOSPITAL_ID)&&scope.row.operatorName" :style="{textAlign:'center'}">停嘱人：{{scope.row.operatorName}}</div>
            </div>
          </template>
        </el-table-column>
        <!--
