      ...
      <div class="right-part" v-loading="tableLoading">
        <div class="sheetTable-contain" ref="scrollCon">
          <div ref="sheetTableContain">
            <sheetTable v-for="(item, index) in filterSheetModel" :key="index" :data="item.data" :index="item.index" :length="item.length"></sheetTable>
          </div>
          <div v-show="sheetModel.length == 0" class="null-btn" flex="cross:center main:center" @click="addSheetPage">
...
<script>
import sheetTool from "@/Page/deep-page/components/sheet-tool/sheet-tool.vue";
import patientList from "@/Page/deep-page/components/patient-list/patient-list.vue";
import sheetTable from "@/Page/deep-page/components/sheetTable/sheetTable.vue";
...
import sheetModel, {
  ...
  initSheetPage,
  cleanData
} from "@/Page/deep-page/sheet.js";
import { patients } from "@/api/lesion";
import decode from "@/Page/deep-page/components/render/decode.js";
import {
  saveBody,
  showBody,
  showTitle,
  ...
  markList,
  saveRelObj
} from "@/Page/deep-page/api/sheet.js";
import sheetInfo from "@/Page/deep-page/components/config/sheetInfo/index.js";
import bus from "vue-happy-bus";
import delPageModal from "@/Page/deep-page/components/modal/del-page.vue";
import $ from "jquery";
import HjModal from "@/Page/deep-page/components/modal/hj-modal.vue";
import signModal from "@/components/modal/sign.vue";
import specialModal from "@/Page/deep-page/components/modal/special-modal.vue";
import setPageModal from "@/Page/deep-page/components/modal/setPage-modal.vue";
import pizhuModal from "@/Page/deep-page/components/modal/pizhu-modal.vue";
import setDiagsModal from "@/Page/deep-page/components/modal/set-diags.vue";
import { getHomePage } from "@/Page/deep-page/api/index.js";
export default {
  mixins: [common],
  data() {
    return {
