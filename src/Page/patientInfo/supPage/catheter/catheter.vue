...
<script>
import sheetTool from "@/Page/catheter-page/components/sheet-tool/sheet-tool.vue";
import patientList from "@/Page/catheter-page/components/patient-list/patient-list.vue";
import sheetTable from "@/Page/catheter-page/components/sheetTable/sheetTable.vue";
...
import sheetModel, {
  ...
  initSheetPage,
  cleanData
} from "@/Page/catheter-page/sheet.js";
import { patients } from "@/api/lesion";
import decode from "@/Page/catheter-page/components/render/decode.js";
import {
  saveBody,
  showBody,
  showTitle,
  ...
  markList,
  saveRelObj
} from "@/Page/catheter-page/api/sheet.js";
import sheetInfo from "@/Page/catheter-page/components/config/sheetInfo/index.js";
import bus from "vue-happy-bus";
import delPageModal from "@/Page/catheter-page/components/modal/del-page.vue";
import $ from "jquery";
import HjModal from "@/Page/catheter-page/components/modal/hj-modal.vue";
import signModal from "@/components/modal/sign.vue";
import specialModal from "@/Page/catheter-page/components/modal/special-modal.vue";
import setPageModal from "@/Page/catheter-page/components/modal/setPage-modal.vue";
import pizhuModal from "@/Page/catheter-page/components/modal/pizhu-modal.vue";
import setDiagsModal from "@/Page/catheter-page/components/modal/set-diags.vue";
import { getHomePage } from "@/Page/catheter-page/api/index.js";
export default {
  mixins: [common],
  data() {
    return {
