...
export default {
  ...
  data() {
    return {
      ...
      showBloodSugar:['guizhou','hengli','huadu','whfk', 'beihairenyi', 'nanfangzhongxiyi', 'sdlj' , 'foshanrenyi', 'fsxt', 'zhzxy', 'lyyz','whsl','ytll','dglb','whhk','nfyksdyy','zjhj','hzly','sdhpwk'], // 是否开放血糖模块
