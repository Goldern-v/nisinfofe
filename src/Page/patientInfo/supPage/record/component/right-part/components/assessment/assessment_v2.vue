  ...
  methods: {
    ...
    onFormLoaded(type = "") {
      ...
      if (
        ...
        const hospitalRules = {
          'hj': ['J0010', 'operationInstrumentDressing'].includes(this.info.formCode),
          'zhzxy': ['ZHZXY_E0007', 'ZHZXY_E0031', 'ZHZXY_E0004'].includes(this.info.formCode),
        }
        if (
    ...
    onload() {
      ...
      if (
        ...
        this.$nextTick(() => {
          ...
          const hospitalRules = {
            'hj': ['J0010', 'operationInstrumentDressing'].includes(this.info.formCode),
            'zhzxy': ['ZHZXY_E0007', 'ZHZXY_E000', 'E1760', 'ZHZXY_E0031', 'ZHZXY_E0004'].includes(this.info.formCode),
            'whsl': true
          }
          if (hospitalRules[this.HOSPITAL_ID]) {
