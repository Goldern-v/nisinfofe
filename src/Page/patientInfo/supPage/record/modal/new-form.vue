  ...
  <div class="modal-con">
    ...
    >
      ...
      <div
        ...
        >
          <!-- 收藏的评估单标记 -->
         <span class="likePng"  v-if="['foshanrenyi', 'whsl','nfyksdyy','zjhj', 'hzly','sdhpwk'].includes(HOSPITAL_ID)">
                <img
      ...
      <div slot="button" @click="newRecordClose">
        ...
        <el-button
          ...
          v-if="['foshanrenyi', 'whsl','nfyksdyy', 'zjhj','hzly','sdhpwk'].includes(HOSPITAL_ID)"
         >取消收藏
        </el-button>
        <el-button
          class="modal-btn"
