...
import TemperatureWHHK from "@/Page/temperature-chart/new-singleTemperature-chart-whhk/components/temperatureNew";
import TabCon from "@/Page/temperature-chart/new-singleTemperature-chart-whhk/components/tab-con";
export default {
  mixins: [common],
  props: {},
  data() {
  ...
  components: { TemperatureWHHK, TabCon },
  watch: {
    deptCode(val) {
      if (val) {
        this.getData();
