...
import temperatureLY from "@/Page/temperature-chart/new-singleTemperature-chart-hj/components/temperatureNew";
import tabCon from "@/Page/temperature-chart/new-singleTemperature-chart-hj/components/tab-con";
export default {
  mixins: [common],
  props: {},
  data() {
