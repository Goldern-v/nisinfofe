...
import temperatureWHYX from "@/Page/temperature-chart/new-singleTemperature-chart-whyx/components/temperatureNew";
import tabCon from "@/Page/temperature-chart/new-singleTemperature-chart-whyx/components/tab-con";
export default {
  mixins: [common],
  props: {},
  data() {
  ...
  components: { temperatureWHYX, tabCon },
  watch: {
    deptCode(val) {
      if (val) {
        this.getData();
