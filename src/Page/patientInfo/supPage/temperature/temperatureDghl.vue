<template>
  <div class="new-singleTemperature-chart-dghl">
    <div
      class="body-con"
      id="sheet_body_con"
...
.new-singleTemperature-chart-dghl {
  position: relative;
...
import temperatureNew from "@/Page/temperature-chart/new-singleTemperature-chart-dghl/components/temperatureNew";
