<template>
  <div>
    <div class="contain">
      <div class="print-btn tool-btn" @click="onPrint()">
        打印
      </div>
      ...
      <div class="tem-con" :style="contentHeight">
        ...
        <iframe
          ...
          ref="pdfCon"
          :class="
            HOSPITAL_ID === 'huadu' || HOSPITAL_ID === 'wujing'
              ? 'hdIframe'
              : ''
          "
        ></iframe>
  ...
  methods: {
    onPrint() {
      this.$refs.pdfCon.contentWindow.postMessage(
        ...
        "http://58.248.14.84:9091/temperature/#/"
      );
    },
    getImg() {
      ...
      /* 单独处理体温单，嵌套iframe */
      const tempUrl = `http://58.248.14.84:9091/temperature/#/?PatientId=${patientId}&VisitId=${visitId}&StartTime=${date}`;
