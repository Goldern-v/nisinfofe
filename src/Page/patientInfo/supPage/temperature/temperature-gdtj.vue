...
import temperatureNew from "@/Page/temperature-chart/new-singleTemperature-chart-gdtj/components/temperatureNew";
import tabCon from "@/Page/temperature-chart/new-singleTemperature-chart-gdtj/components/tab-con";
export default {
  mixins: [common],
  props: {},
  data() {
