      ...
      <tbody>
        ...
        >
          ...
          <td v-for="o in object" :key="o + 'a'">
              <span class="is-radio" v-if="data['教育对象'].indexOf(o) != -1" :key="index">√</span>
          </td>
          <!-- 教育方法 -->
          <td v-for="p in method" :key="p + 'b'">
            <span class="is-radio" v-if="data['教育方法'].indexOf(p) != -1">√</span>
          </td>
          <!-- 教育评估 -->
          <td v-for="q in assessment" :key="q + 'c'">
            <span class="is-radio" v-if="data['教育评估'].indexOf(q) != -1">√</span>
          </td>
          <!-- 备注 -->
  ...
  methods: {
    ...
    setTableData(val) {
      ...
      val.map((item, index) => {
        ...
        // console.log(pageParam['教育对象'].split(','),"-----------------item");
        this.$set(this.tableData[index], "教育对象", pageParam['教育对象'].split(','))
        this.$set(this.tableData[index], "教育方法", pageParam['教育方法'].split(','))
        this.$set(this.tableData[index], "教育评估", pageParam['教育评估'].split(','))
