  ...
  <div style="width: 100vw;height: 100vh">
    <form id="form1" runat="server">
      <table id="ttotal">
        <tr>
          <td>
            <span @click="callActiveX" >查询状态</span>
          </td>
        </tr>
      </table>
    </form>
...
export default {
  ...
  mounted() {
    ...
    //   console.log("OCX返回的患者路径状态为:" + active.LCP_GetCPState(str))
    // } catch (e) {
    //   console.log("e====", visitId, patientNo, cpIncludeDeptCode)
    // }
    this.callActiveX()
  },
  methods:{
    callActiveX(){
      ...
      var str = '<?xml version=\"1.0\" encoding=\"gb2312\"?>'
          ...
          + '<DISCHARGEDDATE></DISCHARGEDDATE>'
          + '</INPUTPARA>';
      var active = document.getElementById("ActiveX1");
      active.LCP_GetCPState(str);//lcp_setOrder 方法
      console.log("OCX返回的患者路径状态为:" + active.LCP_GetCPState(str));//弹窗显示患者路径信息，测试用
    }
  }
}
</script>
