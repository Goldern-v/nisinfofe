...
(
    ...
    ***************************************************************************** */
        ...
        var createCounterStyleFromRange = function(value, codePointRangeStart, codePointRangeEnd, isNumeric, suffix) {
            ...
            return (
                (value < 0 ? '-' : '') +
                (createCounterStyleWithSymbolResolver(Math.abs(value), codePointRangeLength, isNumeric, function(
                    codePoint
                ) {
                ...
                var iframeLoad = iframeLoader(iframe).then(function() {
                    ...
                    if (typeof _this.clonedReferenceElement === 'undefined') {
                        return Promise.reject(
                            'Error finding the ' + _this.referenceElement.nodeName + ' in the cloned document'
                        );
                    }
                                        ...
                                        switch (_f.label) {
                                            ...
                                            case 5:
                                                if (isLinearGradient(backgroundImage)) {
                                                    ...
                                                    (_e = calculateRadius(backgroundImage, x, y, width, height)),
                                                        (rx = _e[0]),
                                                        (ry = _e[1]);
                                                    if (rx > 0 && rx > 0) {
                                                        ...
                                                        processColorStops(backgroundImage.stops, rx * 2).forEach(
                                                            function(colorStop) {
