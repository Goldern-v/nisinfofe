<template>
<div>
  <div class="form-modal_">
    <!-- size="record" width='400px'-->
    <sweet-modal ref="modal" size="record" :title="title" :fullBtn="true" @close="beforeClose" :modalWidth="600" >
      ...
      <div slot="button" style="text-align:center">
        <el-button class="modal-btn" @click="$refs.modal.close()">关闭</el-button>
